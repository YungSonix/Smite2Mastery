      ...
      {selectedItem ? (() => {
        ...
        return (
                ...
                {skinsExpanded &&
                  ...
                  !selectedGod.skins[selectedSkin].hideFromSkinList && (
                    <SkinShowcasePanel
                      ...
                      pantheon={getGodPantheon(selectedGod) || selectedGod.pantheon || null}
          ...
          <KitAbilityTooltipModal
            ...
            iconContentFit={kitAbilityTooltip?.slotId === 'kit-aspect' ? 'contain' : 'cover'}
            onLevelIndexChange={(levelIndex) =>
              setKitAbilityTooltip((prev) => (prev ? { ...prev, levelIndex } : prev))
            }
            onCardHoverIn={cancelClearKitTooltip}
            onCardHoverOut={() => {
...
const styles = StyleSheet.create({
  ...
  ...counterplayTooltipStylesForData,
  outerContainer: {
    flex: 1,
