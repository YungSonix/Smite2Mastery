...
const styles = StyleSheet.create({
  ...
  packRevealPanel: { backgroundColor: BGC, width: '100%', maxWidth: 460, borderTopLeftRadius: 12, borderTopRightRadius: 12, borderTopWidth: 1, borderLeftWidth: 1, borderRightWidth: 1, borderColor: UI_THEME.borderCyanSoft, padding: 12, paddingBottom: 18, maxHeight: '86%' },
  ...
  modalOverlay: { flex: 1, backgroundColor: UI_THEME.overlayScrim, justifyContent: 'flex-end', alignItems: 'center' },
  inspectOverlay: { flex: 1, backgroundColor: 'rgba(3, 7, 18, 0.88)', justifyContent: 'center', alignItems: 'center', paddingHorizontal: 12 },
  inspectPanel: { width: '100%', maxWidth: 430, alignItems: 'center', backgroundColor: UI_THEME.cardBg, borderWidth: 1, borderColor: UI_THEME.borderCyanSoft, borderRadius: 14, paddingVertical: 14, paddingHorizontal: 12, overflow: 'hidden' },
  ...
  htpPanel: { backgroundColor: BGC, width: '100%', maxWidth: 430, borderTopLeftRadius: 14, borderTopRightRadius: 14, borderTopWidth: 1, borderLeftWidth: 1, borderRightWidth: 1, borderColor: UI_THEME.borderCyanSoft, padding: 14, paddingBottom: 20, maxHeight: '78%' },
  ...
  leaderInfoOverlay: { flex: 1, backgroundColor: UI_THEME.overlayScrim, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 14 },
  leaderInfoPanel: { backgroundColor: UI_THEME.panelBg, width: '100%', maxWidth: 430, borderRadius: 14, borderWidth: 1, borderColor: UI_THEME.borderCyan, padding: 14, shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.45, shadowRadius: 16, elevation: 10 },
  ...
  shopPanel: { backgroundColor: BGC, width: '100%', maxWidth: 430, borderTopLeftRadius: 12, borderTopRightRadius: 12, borderTopWidth: 1, borderLeftWidth: 1, borderRightWidth: 1, borderColor: UI_THEME.borderCyanSoft, padding: 12, paddingBottom: 18 },
  ...
  deckPanel: { backgroundColor: BGC, width: '100%', maxWidth: 460, borderTopLeftRadius: 12, borderTopRightRadius: 12, borderTopWidth: 1, borderLeftWidth: 1, borderRightWidth: 1, borderColor: UI_THEME.borderCyanSoft, padding: 12, paddingBottom: 18, maxHeight: '86%' },
