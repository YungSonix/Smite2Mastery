...
2. **`product-marketing`** — Sets up the foundational `docs/cursor-agents/product-marketing.md` context file (positioning, ICP, voice). Read this first; Section 2 (Strategic frame) builds on it.
...
- **`product-marketing`** — Run first. Captures positioning, ICP, voice in `docs/cursor-agents/product-marketing.md` so every section of the plan references the same foundation.
