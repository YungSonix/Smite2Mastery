...
import { BarChart, ColumnHistogram, Donut, KpiStrip } from '../components/HostCharts';
        ...
        {!loading && filteredResponses.length && tab === 'players' ? (
          <>
            ...
            <p className="f-muted f-analytics-foot">
              Click a row to open the student profile — per-trivia scores, weak spots, and classroom
              points. Practice test-link submissions are excluded.
