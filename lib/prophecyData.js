...
const PANTHEON_VISUAL_PROFILES = {
  Olympian: { key: 'Olympian', style: CARD_VISUAL_STYLE.SCULPTED_STONE, auraColor: COLORS.gray400, accentColor: COLORS.gray200, particle: 'storm clouds', cardBackId: 'back_olympian' },
  Greek: { key: 'Olympian', style: CARD_VISUAL_STYLE.SCULPTED_STONE, auraColor: COLORS.gray400, accentColor: COLORS.gray200, particle: 'storm clouds', cardBackId: 'back_olympian' },
  Asgardian: { key: 'Asgardian', style: CARD_VISUAL_STYLE.CONSTELLATION, auraColor: COLORS.blueLight, accentColor: COLORS.skySoft, particle: 'aurora ribbons', cardBackId: 'back_asgardian' },
  Norse: { key: 'Asgardian', style: CARD_VISUAL_STYLE.CONSTELLATION, auraColor: COLORS.blueLight, accentColor: COLORS.skySoft, particle: 'aurora ribbons', cardBackId: 'back_asgardian' },
  Eastern: { key: 'Eastern', style: CARD_VISUAL_STYLE.DYNASTY, auraColor: '#f87171', accentColor: COLORS.amberLight, particle: 'ink embers', cardBackId: 'back_eastern' },
  Chinese: { key: 'Eastern', style: CARD_VISUAL_STYLE.DYNASTY, auraColor: '#f87171', accentColor: COLORS.amberLight, particle: 'ink embers', cardBackId: 'back_eastern' },
  Roman: { key: 'Roman', style: CARD_VISUAL_STYLE.DIVINE_GOLD, auraColor: COLORS.amber, accentColor: '#fde68a', particle: 'laurel sparks', cardBackId: 'back_roman' },
  ...
  Mayan: { key: 'Mayan', style: CARD_VISUAL_STYLE.BATTLE_WORN, auraColor: COLORS.emerald400, accentColor: '#86efac', particle: 'jade dust', cardBackId: 'back_mayan' },
  Egyptian: { key: 'Egyptian', style: CARD_VISUAL_STYLE.SACRED_SCROLL, auraColor: COLORS.yellow500, accentColor: '#fde68a', particle: 'golden sand', cardBackId: 'back_egyptian' },
  ...
  Celtic: { key: 'Celtic', style: CARD_VISUAL_STYLE.ILLUMINATED, auraColor: COLORS.statHealth, accentColor: '#86efac', particle: 'verdant runes', cardBackId: 'back_celtic' },
  ...
  Arthurian: { key: 'Arthurian', style: CARD_VISUAL_STYLE.ILLUMINATED, auraColor: COLORS.blueLight, accentColor: COLORS.skyMuted, particle: 'arcane sigils', cardBackId: 'back_arthurian' },
  ...
  'Tales of Arabia': { key: 'Tales of Arabia', style: CARD_VISUAL_STYLE.SACRED_SCROLL, auraColor: COLORS.amber, accentColor: COLORS.amber300, particle: 'desert mirage dust', cardBackId: 'back_tales_of_arabia' },
  ...
  Korean: { key: 'Korean', style: CARD_VISUAL_STYLE.DYNASTY, auraColor: COLORS.skyBright, accentColor: '#bae6fd', particle: 'moon ink', cardBackId: 'back_korean' },
  Yoruba: { key: 'Yoruba', style: CARD_VISUAL_STYLE.DIVINE_GOLD, auraColor: COLORS.orange, accentColor: '#fdba74', particle: 'sunfire embers', cardBackId: 'back_yoruba' },
};

const DEFAULT_VISUAL_PROFILE = {
  key: 'Neutral',
  style: CARD_VISUAL_STYLE.STANDARD,
  auraColor: COLORS.gray400,
  accentColor: '#d1d5db',
...
export const PROPHECY_TRAP_CARDS = [
  { id: 'trap_ice_wall', cardType: CARD_TYPE.TRAP, trapId: 'T1', name: TRAP_CARDS.T1.name, description: TRAP_CARDS.T1.description, trigger: TRAP_CARDS.T1.trigger, iconSource: TRAP_CARDS.T1.iconSource, rarity: TRAP_CARDS.T1.rarity, cost: TRAP_CARDS.T1.cost, summary: 'Block the next attack on an ally' },
  { id: 'trap_shifting_sands', cardType: CARD_TYPE.TRAP, trapId: 'T2', name: TRAP_CARDS.T2.name, description: TRAP_CARDS.T2.description, trigger: TRAP_CARDS.T2.trigger, iconSource: TRAP_CARDS.T2.iconSource, rarity: TRAP_CARDS.T2.rarity, cost: TRAP_CARDS.T2.cost, summary: 'Slow when an enemy enters the front row' },
  { id: 'trap_portal', cardType: CARD_TYPE.TRAP, trapId: 'T3', name: TRAP_CARDS.T3.name, description: TRAP_CARDS.T3.description, trigger: TRAP_CARDS.T3.trigger, iconSource: TRAP_CARDS.T3.iconSource, rarity: TRAP_CARDS.T3.rarity, cost: TRAP_CARDS.T3.cost, summary: 'Send deployer to back row · 10 damage' },
  { id: 'trap_shield_counter', cardType: CARD_TYPE.TRAP, trapId: 'T4', name: TRAP_CARDS.T4.name, description: TRAP_CARDS.T4.description, trigger: TRAP_CARDS.T4.trigger, iconSource: TRAP_CARDS.T4.iconSource, rarity: TRAP_CARDS.T4.rarity, cost: TRAP_CARDS.T4.cost, summary: 'Block leader hit · return 15 damage' },
  { id: 'trap_venom', cardType: CARD_TYPE.TRAP, trapId: 'T5', name: TRAP_CARDS.T5.name, description: TRAP_CARDS.T5.description, trigger: TRAP_CARDS.T5.trigger, iconSource: TRAP_CARDS.T5.iconSource, rarity: TRAP_CARDS.T5.rarity, cost: TRAP_CARDS.T5.cost, summary: 'Bleed 5 on the attacker (2 turns)' },
  { id: 'trap_soul_cage', cardType: CARD_TYPE.TRAP, trapId: 'T6', name: TRAP_CARDS.T6.name, description: TRAP_CARDS.T6.description, trigger: TRAP_CARDS.T6.trigger, iconSource: TRAP_CARDS.T6.iconSource, rarity: TRAP_CARDS.T6.rarity, cost: TRAP_CARDS.T6.cost, summary: 'Cancel a heal · 10 damage instead' },
  { id: 'trap_vine_snare', cardType: CARD_TYPE.TRAP, trapId: 'T7', name: TRAP_CARDS.T7.name, description: TRAP_CARDS.T7.description, trigger: TRAP_CARDS.T7.trigger, iconSource: TRAP_CARDS.T7.iconSource, rarity: TRAP_CARDS.T7.rarity, cost: TRAP_CARDS.T7.cost, summary: 'Halve that ability damage' },
  { id: 'trap_impale', cardType: CARD_TYPE.TRAP, trapId: 'T8', name: TRAP_CARDS.T8.name, description: TRAP_CARDS.T8.description, trigger: TRAP_CARDS.T8.trigger, iconSource: TRAP_CARDS.T8.iconSource, rarity: TRAP_CARDS.T8.rarity, cost: TRAP_CARDS.T8.cost, summary: '25 damage + Stun 1 turn' },
  { id: 'trap_counterstrike', cardType: CARD_TYPE.TRAP, trapId: 'T9', name: TRAP_CARDS.T9.name, description: TRAP_CARDS.T9.description, trigger: TRAP_CARDS.T9.trigger, iconSource: TRAP_CARDS.T9.iconSource, rarity: TRAP_CARDS.T9.rarity, cost: TRAP_CARDS.T9.cost, summary: 'Counter for full damage before the hit' },
  { id: 'trap_divine_snare', cardType: CARD_TYPE.TRAP, trapId: 'T10', name: TRAP_CARDS.T10.name, description: TRAP_CARDS.T10.description, trigger: TRAP_CARDS.T10.trigger, iconSource: TRAP_CARDS.T10.iconSource, rarity: TRAP_CARDS.T10.rarity, cost: TRAP_CARDS.T10.cost, summary: 'Root deployed god 2 turns' },
];

export const PROPHECY_SPELL_CARDS = [
  { id: 'spell_detonate', cardType: CARD_TYPE.SPELL, spellId: 'S1', name: SPELL_CARDS.S1.name, description: SPELL_CARDS.S1.description, iconSource: SPELL_CARDS.S1.iconSource, rarity: SPELL_CARDS.S1.rarity, cost: SPELL_CARDS.S1.cost, summary: '15 damage to all enemies' },
  { id: 'spell_vortex_blast', cardType: CARD_TYPE.SPELL, spellId: 'S2', name: SPELL_CARDS.S2.name, description: SPELL_CARDS.S2.description, iconSource: SPELL_CARDS.S2.iconSource, rarity: SPELL_CARDS.S2.rarity, cost: SPELL_CARDS.S2.cost, summary: '25 damage to one enemy row' },
  { id: 'spell_mirror_strike', cardType: CARD_TYPE.SPELL, spellId: 'S3', name: SPELL_CARDS.S3.name, description: SPELL_CARDS.S3.description, iconSource: SPELL_CARDS.S3.iconSource, rarity: SPELL_CARDS.S3.rarity, cost: SPELL_CARDS.S3.cost, summary: 'Reflect the next ally damage' },
  { id: 'spell_monkey_bounce', cardType: CARD_TYPE.SPELL, spellId: 'S4', name: SPELL_CARDS.S4.name, description: SPELL_CARDS.S4.description, iconSource: SPELL_CARDS.S4.iconSource, rarity: SPELL_CARDS.S4.rarity, cost: SPELL_CARDS.S4.cost, summary: '10 damage · 3 random bounces' },
  { id: 'spell_thunder_drop', cardType: CARD_TYPE.SPELL, spellId: 'S5', name: SPELL_CARDS.S5.name, description: SPELL_CARDS.S5.description, iconSource: SPELL_CARDS.S5.iconSource, rarity: SPELL_CARDS.S5.rarity, cost: SPELL_CARDS.S5.cost, summary: '20 damage + 10 to adjacent' },
  { id: 'spell_searing_light', cardType: CARD_TYPE.SPELL, spellId: 'S6', name: SPELL_CARDS.S6.name, description: SPELL_CARDS.S6.description, iconSource: SPELL_CARDS.S6.iconSource, rarity: SPELL_CARDS.S6.rarity, cost: SPELL_CARDS.S6.cost, summary: '20 damage + 10% max HP bonus' },
  { id: 'spell_undying_flame', cardType: CARD_TYPE.SPELL, spellId: 'S7', name: SPELL_CARDS.S7.name, description: SPELL_CARDS.S7.description, iconSource: SPELL_CARDS.S7.iconSource, rarity: SPELL_CARDS.S7.rarity, cost: SPELL_CARDS.S7.cost, summary: 'Ally survives at 50% HP this turn' },
  { id: 'spell_backfire', cardType: CARD_TYPE.SPELL, spellId: 'S8', name: SPELL_CARDS.S8.name, description: SPELL_CARDS.S8.description, iconSource: SPELL_CARDS.S8.iconSource, rarity: SPELL_CARDS.S8.rarity, cost: SPELL_CARDS.S8.cost, summary: '30 damage + push to back row' },
  { id: 'spell_tidal_wave', cardType: CARD_TYPE.SPELL, spellId: 'S9', name: SPELL_CARDS.S9.name, description: SPELL_CARDS.S9.description, iconSource: SPELL_CARDS.S9.iconSource, rarity: SPELL_CARDS.S9.rarity, cost: SPELL_CARDS.S9.cost, summary: 'Push front row back · 10 each' },
  { id: 'spell_solar_flare', cardType: CARD_TYPE.SPELL, spellId: 'S10', name: SPELL_CARDS.S10.name, description: SPELL_CARDS.S10.description, iconSource: SPELL_CARDS.S10.iconSource, rarity: SPELL_CARDS.S10.rarity, cost: SPELL_CARDS.S10.cost, summary: 'Blind · next enemy attacks deal 0' },
  { id: 'spell_phantom_rush', cardType: CARD_TYPE.SPELL, spellId: 'S11', name: SPELL_CARDS.S11.name, description: SPELL_CARDS.S11.description, iconSource: SPELL_CARDS.S11.iconSource, rarity: SPELL_CARDS.S11.rarity, cost: SPELL_CARDS.S11.cost, summary: 'One ally dodges the next hit' },
  { id: 'spell_chaos_apple', cardType: CARD_TYPE.SPELL, spellId: 'S12', name: SPELL_CARDS.S12.name, description: SPELL_CARDS.S12.description, iconSource: SPELL_CARDS.S12.iconSource, rarity: SPELL_CARDS.S12.rarity, cost: SPELL_CARDS.S12.cost, summary: 'Two random enemies hit each other' },
  { id: 'spell_death_toll', cardType: CARD_TYPE.SPELL, spellId: 'S13', name: SPELL_CARDS.S13.name, description: SPELL_CARDS.S13.description, iconSource: SPELL_CARDS.S13.iconSource, rarity: SPELL_CARDS.S13.rarity, cost: SPELL_CARDS.S13.cost, summary: 'Destroy lowest-HP unit anywhere' },
  { id: 'spell_flame_wave', cardType: CARD_TYPE.SPELL, spellId: 'S14', name: SPELL_CARDS.S14.name, description: SPELL_CARDS.S14.description, iconSource: SPELL_CARDS.S14.iconSource, rarity: SPELL_CARDS.S14.rarity, cost: SPELL_CARDS.S14.cost, summary: 'Front row 20 damage + Bleed 5' },
  { id: 'spell_shards_of_ice', cardType: CARD_TYPE.SPELL, spellId: 'S15', name: SPELL_CARDS.S15.name, description: SPELL_CARDS.S15.description, iconSource: SPELL_CARDS.S15.iconSource, rarity: SPELL_CARDS.S15.rarity, cost: SPELL_CARDS.S15.cost, summary: 'Freeze front row · 15 each' },
];

/** One-line collection/showcase text derived from item stat boosts. */
export function formatProphecyItemSummary(card) {
  const atk = Number(card?.atkBoost ?? 0);
  const hp = Number(card?.hpBoost ?? 0);
  const parts = [];
  if (atk > 0) parts.push(`+${atk} ATK`);
  if (hp > 0) parts.push(`+${hp} HP`);
  return parts.length ? parts.join(' · ') : 'Equip: utility';
}

/** Short body text for collection/showcase (items use boosts; spells/traps prefer `summary`). */
export function getProphecyCardShowcaseBody(card) {
  const t = card?.cardType ?? CARD_TYPE.GOD;
  if (t === CARD_TYPE.GOD) return '';
  if (t === CARD_TYPE.ITEM) return formatProphecyItemSummary(card);
  const s = card?.summary != null ? String(card.summary).trim() : '';
  if (s) return s;
  return String(card?.description || card?.ability?.description || card?.passive?.description || '').trim();
}
