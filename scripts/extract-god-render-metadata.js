 ...
 *
 *   node scripts/extract-god-render-metadata.js --god achilles
 *   node scripts/extract-god-render-metadata.js --god achilles --write
 *   node scripts/extract-god-render-metadata.js --all
 */
const fs = require('fs');
...
async function main() {
  ...
  if (args.help) {
    console.log(`Usage:
  node scripts/extract-god-render-metadata.js --god achilles [--write]
  node scripts/extract-god-render-metadata.js --all [--write]`);
    process.exit(0);
  }
