 ...
 *
 *   node scripts/god-renders/apply-vision-tags-agent-c.js --write
 */
'use strict';
...
const LOG_PATH = path.join(PROJECT_ROOT, 'scripts', 'god-renders', '.vision-tag-agent-c.log');
const NORSE_PATH = path.join(PROJECT_ROOT, 'scripts', 'god-renders', '.vision-tag-norse-batch-b-data.json');
const MAYAN_PATH = path.join(PROJECT_ROOT, 'scripts', 'god-renders', '.vision-tag-agent-c-mayan-data.json');
const CHINESE_MAP_PATH = path.join(PROJECT_ROOT, 'scripts', 'god-renders', 'vision-tag-batch-c-mappings.json');
