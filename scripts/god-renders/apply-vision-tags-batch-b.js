 ...
 *
 * Input: scripts/god-renders/.vision-tag-batch-b-data.json
 * Log:   scripts/god-renders/.vision-tag-batch-b.log
 *
 *   node scripts/god-renders/apply-vision-tags-batch-b.js [--write]
 */
'use strict';
...
const DEFAULT_DATA_PATH = path.join(PROJECT_ROOT, 'scripts', 'god-renders', '.vision-tag-batch-b-data.json');
const DEFAULT_LOG_PATH = path.join(PROJECT_ROOT, 'scripts', 'god-renders', '.vision-tag-batch-b.log');
