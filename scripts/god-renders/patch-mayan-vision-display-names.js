...
const DATA_PATH = path.join(PROJECT_ROOT, 'scripts/god-renders/.vision-tag-mayan-data.json');
...
function main() {
  const src = path.join(PROJECT_ROOT, 'scripts/god-renders/.vision-tag-agent-c-mayan-data.json');
